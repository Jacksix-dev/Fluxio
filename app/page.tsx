...
const integrations: Integration[] = [
  ...
  { name: "Gmail", icon: <Mail className="w-10 h-10" aria-hidden="true" /> },
  {
    name: "Google Sheets",
    icon: (
      <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
function IntegrationsCarousel() {
  const items = useMemo(() => integrations, [])
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#03045E] via-[#023E8A] to-[#03045E] text-[#CAF0F8] relative overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 h-16 backdrop-blur-xl border-b border-[#023E8A]/50 bg-[#03045E]/80">
        <div className="container mx-auto px-6 h-full flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#productos" className="text-sm text-[#ADE8F4] hover:text-[#CAF0F8] transition-colors duration-200">
              Productos
            </a>
            <a href="#integraciones" className="text-sm text-[#ADE8F4] hover:text-[#CAF0F8] transition-colors duration-200">
              Integraciones
            </a>
            <a href="#nosotros" className="text-sm text-[#ADE8F4] hover:text-[#CAF0F8] transition-colors duration-200">
              Nosotros
            </a>
          </div>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="hidden sm:inline-flex px-5 py-2 bg-[#00B4D8] text-[#03045E] text-sm font-medium rounded-full hover:bg-[#48CAE4] transition-all duration-200 shadow-lg shadow-[#00B4D8]/20 hover:shadow-[#00B4D8]/30 hover:scale-105"
            >
          ...
          <div className="md:hidden absolute top-16 left-0 right-0 bg-[#03045E]/95 backdrop-blur-xl border-b border-[#023E8A]/50 shadow-xl">
            <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex w-full justify-center px-5 py-2 bg-[#00B4D8] text-[#03045E] text-sm font-medium rounded-full hover:bg-[#48CAE4] transition-all duration-200 shadow-xl shadow-[#00B4D8]/30"
                onClick={() => setMobileMenuOpen(false)}
              >
                Quiero que me contacten
              </a>
      ...
      <section className="relative px-6 pb-20 scroll-mt-24" id="integraciones">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-medium text-[#CAF0F8] mb-2">Integraciones</h2>
      ...
      {/* Products Section */}
      <section className="relative py-24 px-6 scroll-mt-24" id="productos">
        <div className="container mx-auto max-w-6xl">
